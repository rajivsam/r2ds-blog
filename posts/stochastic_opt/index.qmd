...
## Note:
The primary goal of this post is to highlight how statistical estimation serves as a critical component of stochastic optimization. While the newsvendor model presented here could be a better fit compared to the stock optimization model—the idea was to show that statistical estimation primes the optimization process. 
