...
description: "An applied introduction to stochastic optimization for bakery demand planning, showing how statistical estimation drives optimization decisions under uncertainty."
keywords: [stochastic optimization, demand uncertainty, negative binomial, gamma distribution, newsvendor, AMPL, operations research]
citation:
...
Here is the cost data. The cost of baking a baguette is 53 cents, and the selling price is 90 cents. I used [this article](https://www.busbysbakery.com/how-to-price-bread-to-make-profit/?utm_source=r2ds_blog&utm_medium=post&utm_campaign=stochastic_opt_post) to arrive at pricing information. The gist of the price information is:
$$
