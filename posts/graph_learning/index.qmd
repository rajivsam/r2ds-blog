...
There are two unknowns here: the connectivity of the graph and the _smoothed_ signal value. The graph is defined by its _Laplacian_ matrix, $L$. This is what you want to learn. The smoothing idea is called _Total Variation Smoothing_ and is quite popular. The algorithm and consists of two steps:
