...
This post focuses on time series analysis—understanding the signal's past behavior—as distinct from time series modeling, which is for prediction. The initial step in analysis is to smooth the signal to reveal its core components: trend, cycles, seasonality, and noise.
