...
:::{layout-ncol=3}
![Coffee_Eigen_Values](coffee_eigen_values.png){width="100%" height="100%" style="vertical-align: bottom;"}

![Coffee_Explained_Variance](coffee_eig_var_x.png){width="100%" height="100%" style="vertical-align: bottom;"}

![Coffee_Cumulative_Explained_Variance](coffee_eig_var_cum_x.png){width="100%" height="100%" style="vertical-align: bottom;"}
:::
...
The analysis for all the datasets is at [@sambasivan_ts_explore_26]. Check the [notebooks](https://github.com/rajivsam/ts_exploration/tree/master/notebooks) folder for the notebook implementations. The knowledge graph extracts or the pdf versions of the notebooks can be used with notebook LM to create documentation based on this analysis. The knowledge graphs in the _kmds_ subfolder of the _data_ folder. The generative AI content is in the [_generative ai_](https://github.com/rajivsam/ts_exploration/tree/master/generative_ai_content) folder.
